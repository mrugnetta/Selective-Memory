{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 125.0, 140.0, 1154.0, 584.0 ],
		"bglocked" : 0,
		"defrect" : [ 125.0, 140.0, 1154.0, 584.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 920.0, 590.0, 20.0, 20.0 ],
					"id" : "obj-28",
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 920.0, 700.0, 20.0, 20.0 ],
					"id" : "obj-26",
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 920.0, 645.0, 20.0, 20.0 ],
					"id" : "obj-24",
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontname" : "Arial",
					"patching_rect" : [ 920.0, 670.0, 70.0, 20.0 ],
					"id" : "obj-22",
					"outlettype" : [ "bang" ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontname" : "Arial",
					"patching_rect" : [ 920.0, 620.0, 97.0, 18.0 ],
					"id" : "obj-20",
					"outlettype" : [ "" ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontname" : "Arial",
					"patching_rect" : [ 1024.0, 580.0, 92.0, 18.0 ],
					"id" : "obj-19",
					"outlettype" : [ "" ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontname" : "Arial",
					"patching_rect" : [ 1024.0, 550.0, 60.0, 20.0 ],
					"id" : "obj-17",
					"outlettype" : [ "bang" ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontname" : "Arial",
					"patching_rect" : [ 1030.0, 680.0, 94.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 519.0, 10.0, 92.0, 20.0 ],
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontname" : "Arial",
					"patching_rect" : [ 820.0, 470.0, 150.0, 20.0 ],
					"presentation" : 1,
					"id" : "obj-14",
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontname" : "Arial",
					"patching_rect" : [ 820.0, 580.0, 81.0, 20.0 ],
					"id" : "obj-12",
					"outlettype" : [ "" ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"fontname" : "Arial",
					"patching_rect" : [ 820.0, 550.0, 61.0, 20.0 ],
					"id" : "obj-11",
					"outlettype" : [ "", "" ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"fontname" : "Arial",
					"patching_rect" : [ 820.0, 490.0, 210.0, 46.0 ],
					"presentation" : 1,
					"id" : "obj-4",
					"outlettype" : [ "", "int", "", "" ],
					"keymode" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"fontname" : "Arial",
					"patching_rect" : [ 1024.0, 650.0, 69.0, 20.0 ],
					"id" : "obj-3",
					"outlettype" : [ "", "" ],
					"fontsize" : 12.0,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 829.5, 609.0, 907.5, 609.0, 907.5, 580.0, 929.5, 580.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 929.5, 729.0, 981.5, 729.0, 981.5, 570.0, 1033.5, 570.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-3", 0 ],
					"hidden" : 0,
					"midpoints" : [ 929.5, 643.5, 1033.5, 643.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 0 ],
					"hidden" : 0,
					"midpoints" : [ 829.5, 687.0, 36.0, 687.0, 36.0, 726.0, 59.5, 726.0 ]
				}
